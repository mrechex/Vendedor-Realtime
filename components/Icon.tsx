  ...
  const icons: { [key: string]: React.ReactNode } = {
    logo: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M14.25 2.25a.75.75 0 0 0-1.5 0v1.403a3.375 3.375 0 0 0-1.855 1.855h-1.403a.75.75 0 0 0 0 1.5h1.403a3.375 3.375 0 0 0 1.855 1.855v1.403a.75.75 0 0 0 1.5 0v-1.403a3.375 3.375 0 0 0 1.855-1.855h1.403a.75.75 0 0 0 0-1.5h-1.403a3.375 3.375 0 0 0-1.855-1.855V2.25ZM12 4.125a2.625 2.625 0 1 1 0 5.25 2.625 2.625 0 0 1 0-5.25Z" />
    ...
    microphone: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m12 0v-1.5a6 6 0 0 0-12 0v1.5m6 7.5v4.5m-3-4.5v4.5m6-4.5v4.5" />
      </svg>
    ),
    sparkles: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
